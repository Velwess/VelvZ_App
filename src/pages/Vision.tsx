    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow-lg p-8 space-y-6">
        <p className="text-lg leading-relaxed text-gray-700">
          La vision de <span className="font-bold text-[#E6A4B4]">VelZ</span> est de devenir la plateforme de référence
        ...
        <p className="text-lg leading-relaxed text-gray-700">
          ...
          et plus encore, <span className="font-bold text-[#E6A4B4]">VelZ</span> veut rendre ces opportunités accessibles
