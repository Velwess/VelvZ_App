...
export default function HomeClientPage(props: HomeClientPageProps) {
  ...
  return <section>
    ...
    <article className="relative overflow-hidden rounded-3xl mb-12">
      {/* Background Image */}
      <div
    ...
    <article className="mb-16">
      <div className="flex items-center justify-between mb-6">
        ...
        {/*  to="/offres"*/}
        {/*  className="text-s
          econdary hover:text-[#DA70D6] font-semibold flex items-center"*/}
        {/*>*/}
        ...
        <div className="relative px-8 py-16 md:px-16">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mt-12">
              <Link
                href="/inscription"
                className="inline-flex items-center bg-gradient-to-r from-secondary to-[#DA70D6] text-white px-8 py-4 rounded-full font-semibold shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105"
              >
    ...
    <article className="mb-16 bg-white rounded-3xl p-12">
      <div className="text-center mb-12">
    ...
    <article className="mb-16 bg-white rounded-3xl p-12">
      ...
      <div className="text-center">
        <Link
          href="/partenaire"
          className="bg-secondary hover:bg-[#DA70D6] text-white px-8 py-3 rounded-full font-semibold transition-colors inline-flex items-center"
        >
          Devenir partenaire
    ...
    {/* Sign Up Section */}
    <article className="bg-gradient-to-r from-[#F4C2C2] to-[#C8A2C8] rounded-3xl p-12 text-white">
