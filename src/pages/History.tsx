    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow-lg p-8 space-y-6">
        <p className="text-lg leading-relaxed text-gray-700">
          ...
          d'aller mieux dans une societe ou pa danté mentale des jeunes s'affaiblit et la multiplication d'enseigne de fast food bon marché se multiplie 
          VelZ est né afin de promouvoir un nouveau modele de vie ou on ne vit pas pour travailler quitte à altered sa sante on travail
          pour bien vivre. 
          La raison d'etre est trouvée neanmoins entre l'inflation et le prix de bien vivre ce n'est pas accessible à tous. Notre but est
