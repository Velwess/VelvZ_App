...
export default function HomeClientPage(props: HomeClientPageProps) {
  ...
  return <section className="relative overflow-hidden rounded-3xl mb-12">
    {/* Background Image */}
    <div
    ...
    <div className="relative p-12">
      <div className="max-w-2xl">
        <h1 className="text-4xl font-bold text-white mb-4">
          🚧 Velz la plateforme qui facilite l'accès à une vie plus saine 🌿
          est en cours de développement ! 🚀
        </h1>

        <h5 className="text-lg text-white/90 mb-4 ">
          Consultez une sélection d'offres dénichées avec soin pour vous 💥{" "}
        </h5>
        ...
        <Link
          href="/inscription"
          className="bg-white hover:bg-white/90 text-primary px-8 py-3 rounded-full font-semibold shadow-lg transition-all duration-300 hover:shadow-xl inline-flex items-center group"
        >
          Je me préinscris
  ...
  <section className="mb-16">
    <div className="flex items-center justify-between mb-6">
      ...
      {/*<Link*/}
      {/*  to="/offres"*/}
      {/*  className="text-secondary hover:text-primary font-semibold flex items-center"*/}
      {/*>*/}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <Link href="/inscription">
                  <span
                    className="inline-block bg-[#F4C2C2]/20 text-secondary px-4 py-1 rounded-full text-sm font-medium mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div
              ...
              <div
                className="w-16 h-16 bg-gradient-to-br from-[#F4C2C2] to-secondary rounded-2xl flex items-center justify-center mx-auto mb-6 transform rotate-3 group-hover:rotate-6 transition-transform">
          ...
          <div className="text-center mt-12">
            <Link
              href="/inscription"
              className="inline-flex items-center bg-gradient-to-r from-secondary to-primary text-white px-8 py-4 rounded-full font-semibold shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105"
            >
      ...
      <div className="bg-[#F4C2C2]/10 rounded-2xl p-8 flex items-start space-x-6">
        ...
        <div>
          ...
          <p className="text-gray-600">
            ...
            enrichissantes. Nous voulons améliorer la qualité de vie de nos
            utilisateurs.
          </p>
        </div>
      </div>
  ...
  <section className="mb-16 bg-white rounded-3xl p-12">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
      <div className="text-center">
        <Building2 size={48} className="text-secondary mx-auto mb-4"/>
    ...
    <div className="text-center">
      <Link
        href="/partenaire"
        className="bg-secondary hover:bg-primary text-white px-8 py-3 rounded-full font-semibold transition-colors inline-flex items-center"
      >
        Devenir partenaire
    ...
    <div className="max-w-3xl mx-auto text-center">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-4">
        <input
          ...
          className="px-6 py-3 rounded-full text-gray-800 focus:outline-none focus:ring-2 focus:ring-primary md:w-80"
        />
        <Link
          href="/inscription"
