          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-8">
              <Link to="/" className="logo-container">
                <Sparkles
                  className="text-[#E6A4B4] absolute -left-1 -top-1"
                  size={16}
                />
              ...
              <nav className="hidden md:flex space-x-6">
                {categories.map((cat) => (
                  <Link
                    ...
                    className={`flex items-center space-x-1 py-2 rounded-full transition-all duration-300 transform hover:scale-105
                      ${
                        location.pathname.startsWith("/offres") &&
